...
Pizza_msg1_jap: 	  db 10110001B,11010111B,10110011B,11000100B,11011110B,10100101B,10110010B,11011101B, 10100101B,11001011B,10110001B, 0
...
$NOLIST
$include(menu_code_a1_katakana.asm) ; A library of 7 segment displays related functions and utility macros
$LIST
