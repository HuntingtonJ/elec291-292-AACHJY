...
reflow_state_machine: 
	...
	state1:
			...
			Set_Cursor(1,9)
	Send_Constant_String(#Ramp_to_Soak)		; display current state
	...
	state2:
			...
			;Reflow_screen(Soak)
			Set_Cursor(1,9)
	Send_Constant_String(#Soak)		; display current state
	...
	state3:
			...
			Set_Cursor(1,9)
	Send_Constant_String(#Ramp_to_Peak)		; display current state
	...
	state4:
			...
			Set_Cursor(1,9)
	Send_Constant_String(#Reflow)		; display current state
	...
	state5:
			...
			Set_Cursor(1,9)
	Send_Constant_String(#Cooling)		; display current state
